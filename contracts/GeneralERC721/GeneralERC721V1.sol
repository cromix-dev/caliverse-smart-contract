  ...
  ERC721EnumerableUpgradeable
{
  ...
  function setSaleInfo(
    ...
    saleInfo.saleKey = publicSaleKey_;
  ...
  function publicMint(
    ...
    uint256[] memory tokenIds = _publicMint(stakingContract, quantity, key_);
  ...
  function _publicMint(address to, uint256 quantity, uint256 key_) private onSale returns (uint256[] memory) {
    LibSale.validatePublicSale(saleInfo, quantity, key_);
  ...
  function adminBulkMint(address to, uint256[] memory amounts) public isAdmin {
